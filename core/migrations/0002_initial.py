    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="songs_satisfying", to="core.session"
            ),
        ),
        migrations.AddField(
            model_name="song",
            ...
            field=models.ManyToManyField(
                related_name="songs_unsatisfying", to="core.session"
            ),
        ),
        migrations.AddField(
            model_name="team",
        ...
        migrations.AddField(
            ...
            name="performance",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="core.performance"
            ),
        ),
        migrations.AddField(
            model_name="song",
